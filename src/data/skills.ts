...
export const SKILL_GROUPS: SkillGroup[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'SQL', level: 'expert', projects: ['vantage-bi', 'helio-crm'] },
      { name: 'Data Modelling', level: 'expert', projects: ['vantage-bi'], note: 'Star schema, slowly changing dimensions' },
      { name: 'dbt', level: 'advanced', projects: ['vantage-bi'] },
      ...
      { name: 'ETL / ELT Design', level: 'expert', projects: ['vantage-bi'] },
